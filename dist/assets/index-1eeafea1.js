(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const n of o.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function r(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(a){if(a.ep)return;a.ep=!0;const o=r(a);fetch(a.href,o)}})();document.querySelector("#app").innerHTML="";const t=()=>{let e=document.createElement("div");e.id="mydiv";let i=document.createElement("img");i.src="img/JavaScript-logo.jpg",e.appendChild(i);let r=document.createElement("div");r.id="myDiv2",r.innerHTML="<h2>Desarrollos JavaScript</h2>",e.appendChild(r),document.body.appendChild(e)},d=()=>{var e=document.createElement("div");e.id="myDivNav",document.body.appendChild(e);var i=document.createElement("div");i.className="mydivClass",i.id="btnInicio",i.innerHTML="JavaScript",e.appendChild(i),document.getElementById("btnInicio").addEventListener("click",()=>{p()});var r=document.createElement("div");r.className="mydivClass",r.id="btnQsomos",r.innerHTML="Ebooks",e.appendChild(r),document.getElementById("btnQsomos").addEventListener("click",()=>{l()});var s=document.createElement("div");s.className="mydivClass",s.id="btnDescargas",s.innerHTML="Descargas",e.appendChild(s),document.getElementById("btnDescargas").addEventListener("click",()=>{u()});var a=document.createElement("div");a.className="mydivClass",a.id="btnContacto",a.innerHTML="Repositorio",e.appendChild(a),document.getElementById("btnContacto").addEventListener("click",()=>{m()})},c=()=>{let e=document.createElement("div");e.id="myDivNav2",e.innerHTML=`
   <ul>
...
`},p=()=>{document.querySelector("#myDivNav2").innerHTML=` JavaScript es un lenguaje de programación
  ...
  `},u=()=>{document.querySelector("#myDivNav2").innerHTML=`<h4>Descargas:</h4>
    <br>
    <div id = "divImg">
    ...
    <br><br><br><br><br><br>
    `},m=()=>{document.querySelector("#myDivNav2").innerHTML=`<h4>Descargas:</h4>
  <br>
  <div id = "divImg">
  <div class = "divItemDesc">  
  <a id="pdfLink" href="https://github.com/BairesJs/app/">
      <img class ="imgDesc" src="img/gitHub.jpg" alt="Descargar PDF" style="width: 300px; height: auto;" >
  </a>
  </div>
`},v=()=>{let e=document.createElement("div"),i=document.createElement("div");i.id="divDatos1",i.innerHTML=`
  <div>
   <p> Twitter: @Bairesjs  </p>
   <p> Instagram: @Baires.js </p>
   </div>
   `,e.appendChild(i),e.id="mydivPie";let r=document.createElement("img");r.id="img1",r.src="img/pieJavaScript.jpg",e.appendChild(r),document.body.appendChild(e)};t();d();c();v();
