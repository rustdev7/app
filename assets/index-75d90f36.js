...
`},g=()=>{let e=document.createElement("div"),i=document.createElement("div");i.id="divDatos1",i.innerHTML=`
  ...
  <a id="whatsapp" style = "text-decoration: none;" href="https://api.whatsapp.com/send?phone=1134795400">
    ...
    <hr>
   `,e.appendChild(i),e.id="mydivPie";let o=document.createElement("img");o.id="img1",o.src="img/pieJavaScript.jpg",e.appendChild(o),document.body.appendChild(e)};t();d();c();g();
