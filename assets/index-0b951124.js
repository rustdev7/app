(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const t of r.addedNodes)t.tagName==="LINK"&&t.rel==="modulepreload"&&s(t)}).observe(document,{childList:!0,subtree:!0});function o(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(a){if(a.ep)return;a.ep=!0;const r=o(a);fetch(a.href,r)}})();document.querySelector("#app").innerHTML="";const n=()=>{let e=document.createElement("div");e.id="mydiv";let i=document.createElement("img");i.src="img/JavaScript-logo.jpg",e.appendChild(i);let o=document.createElement("div");o.id="myDiv2",o.innerHTML=`
    &#160;&#160;&#160;&#160;
...
`,e.appendChild(o),document.body.appendChild(e)},d=()=>{var e=document.createElement("div");e.id="myDivNav",document.body.appendChild(e);var i=document.createElement("div");i.className="mydivClass",i.id="btnInicio",i.innerHTML="JavaScript",e.appendChild(i),document.getElementById("btnInicio").addEventListener("click",()=>{p()});var o=document.createElement("div");o.className="mydivClass",o.id="btnQsomos",o.innerHTML="Ebooks",e.appendChild(o),document.getElementById("btnQsomos").addEventListener("click",()=>{l()});var s=document.createElement("div");s.className="mydivClass",s.id="btnDescargas",s.innerHTML="Descargas",e.appendChild(s),document.getElementById("btnDescargas").addEventListener("click",()=>{m()});var a=document.createElement("div");a.className="mydivClass",a.id="btnContacto",a.innerHTML="Repositorio",e.appendChild(a),document.getElementById("btnContacto").addEventListener("click",()=>{u()})},c=()=>{let e=document.createElement("div");e.id="myDivNav2",e.innerHTML=`
   <ul>
...
`},p=()=>{document.querySelector("#myDivNav2").innerHTML=` JavaScript es un lenguaje de programación
  ...
  `},m=()=>{document.querySelector("#myDivNav2").innerHTML=`<h4>Descargas:</h4>
    ...
    <div>
    <br>
    <a href="https://bairesjs.github.io/motos/" style="text-decoration: none;">Pagina de Motos</a>
    <br><br>
    <a href="https://bairesjs.github.io/preciodeamigo/" style="text-decoration: none;">Pagina de Herreria</a>
    </div>
    </div>
    ...
    <br><br><br><br><br><br>
    `},u=()=>{document.querySelector("#myDivNav2").innerHTML=`<h4>Descarga gratis de todos los proyectos:</h4>
  <br>
  <div id = "divImg">
  <div class = "divItemDesc">  
...
`},v=()=>{let e=document.createElement("div"),i=document.createElement("div");i.id="divDatos1",i.innerHTML=`
  ...
  <a id="whatsapp" style = "text-decoration: none;" href="https://api.whatsapp.com/send?phone=1134795400">
    ...
    <hr>
   `,e.appendChild(i),e.id="mydivPie";let o=document.createElement("img");o.id="img1",o.src="img/pieJavaScript.jpg",e.appendChild(o),document.body.appendChild(e)};n();d();c();v();
