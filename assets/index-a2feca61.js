...
`},b=()=>{let e=document.createElement("div"),i=document.createElement("div");i.id="divDatos1",i.innerHTML=`
  ...
  <p class="mb-0">Twitter: @Bairesjs</p>
  <p class="mt-0">Instagram: @Baires.js</p>  
   
   `,e.appendChild(i),e.id="mydivPie";let r=document.createElement("img");r.id="img1",r.src="img/pieJavaScript.jpg",e.appendChild(r),document.body.appendChild(e)};t();d();c();b();
