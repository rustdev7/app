...
`},b=()=>{let e=document.createElement("div"),i=document.createElement("div");i.id="divDatos1",i.innerHTML=`
   ...
   <br>
  `,e.appendChild(i),e.id="mydivPie";let o=document.createElement("img");o.id="img1",o.src="img/pieJavaScript.jpg",e.appendChild(o),document.body.appendChild(e)};t();d();c();b();
